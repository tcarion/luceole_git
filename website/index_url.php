...
function build_url($mode, $page) {
  ...
  $array = ["nav" => "content/nav.php",
            ...
            "coexistence_milan" => "files/coexistence_milan.pdf",
            "precarite_sociale" => "files/precarite_sociale.pdf",
            "coexistence_milan_couverture" => "files/coexistence-milan-couverture.png",
            "precarite_sociale_couverture" => "files/precarite-sociale-couverture.png",
  ...
  if ($mode == 'html') {
    $file_location = constant('ROOT_URL').'/luceole/'.$array[$page];
  }

  elseif ($mode == 'php') {
    $file_location = constant('SERVER_ROOT').'/luceole/'.$array[$page];
  }
